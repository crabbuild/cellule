...
The reference application is a runnable use case for SQL, KV, Blob, Queue, Workflow, Activity, Cron, and Effect primitives. Keep examples compiled and verify their visible outcomes. Read `PERFORMANCE.md` before changing ignored benchmarks; preserve measured-run provenance. Run `cargo test -p cellule-app --locked` after changes.
