...
fn compiled() -> cellule_app::CompiledApplication {
...
fn compile_reference_in_order(reverse: bool) -> cellule_app::CompiledApplication {
...
async fn seed_reference_session(layout: &CellStorageLayout, session: cellule_runtime::SessionId) {
...
async fn fence_reference_session(
    ...
    claimant: cellule_runtime::SessionId,
) -> FencedNodeSession {
    let directory = NodeDirectory::new(
        layout.clone(),
        Digest::from_bytes([90; 32]),
        ...
        Box::pin(async move {
            ...
            match operation.primitive() {
                ...
                "activity" => {
                    ...
                    let supervisor = cellule_runtime::ActivitySupervisor::new(activities, 5_000)?;
                    supervisor
                        .run_once(0, None)
                        .await
...
async fn typed_application_executes_every_primitive_through_a_local_router() {
    ...
    let takeover_session = cellule_runtime::SessionId::from_bytes([70; 16]);
    ...
    restored_workflow
        ...
        .await
        .unwrap();
    let restored_activity = cellule_runtime::ActivitySupervisor::new(
