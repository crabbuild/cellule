...
use cellule_ltx::rusqlite::{Connection, Transaction};
...
/// Statically dispatched typed command implemented by compiled application code.
...
/// Statically dispatched typed query implemented by compiled application code.
...
/// Source-level module registration contract for statically linked application code.
