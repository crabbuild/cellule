...
impl WorkflowDefinition for ExpiryDefinition {
    fn digest(&self) -> cellule_runtime::Digest {
        cellule_runtime::Digest::from_bytes([9; 32])
    }
...
impl WorkflowDefinition for EffectDefinition {
    fn digest(&self) -> cellule_runtime::Digest {
        cellule_runtime::Digest::from_bytes([10; 32])
    }
...
fn advertisement_with_capacity(
    ...
    NodeAdvertisement::sign(
        cellule_runtime::NodeId::from_bytes([session; 16]),
