...
Cell authority is the publication boundary implemented by `cellule-runtime`,
not by `cellule-ltx`. It stores one strict, versioned control record for a Cell:
...
publication succeeds. This is how `cellule-runtime` avoids duplicating a
